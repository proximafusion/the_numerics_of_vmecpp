...
\input{00_know_your_tools.tex}
\input{01_toroidal_coordinate_system.tex}
\input{02_spectral_condensation.tex}
\input{03_vmec.tex}
\input{04_nestor.tex}
\input{05_nestor_vac3.tex}
\input{06_vmec_inputs.tex}
\input{07_vmec_outputs.tex}
\input{08_using_vmec.tex}
\input{09_bnorm.tex}
\input{10_solovev.tex}
...
\begin{itemize}
 ...
 \item Thanks to Jan-Peter Bähner for providing the section on the calculation of $\nabla \alpha$.
 \item Thanks to Camilla Lazzati for providing the section on coordinate sign conventions,
       adapting Matt Landreman's notes on Fortran VMEC and manually verifying them for VMEC++.
