...
\begin{itemize}
 ...
 \item \texttt{free\_boundary\_method} \\
       ...
       and \texttt{"only_coils"} for using only the vacuum field due to external coils.
       The option \texttt{"only_coils"} only works for zero pressure (\texttt{pres\_scale = 0})
